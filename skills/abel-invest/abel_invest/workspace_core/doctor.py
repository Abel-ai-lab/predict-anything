    ...
    result.update(
        {
            ...
            "next_step": (
                ...
                "# runs live graph discovery; then init a scout/candidate branch -> prepare-branch -> about-5-minute first-look scout before any broad run; do not stop it early within that window"
            ),
        }
    )
    return result
