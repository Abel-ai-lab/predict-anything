...
def build_context_guide_markdown(
    *,
    ...
    lines = [
        ...
        "2. For broad input spaces, scout one sharp question in `research/<ticker>/<session_id>/scratch/`, a one-off heredoc, or a notebook/query cell; scratch enables high-capacity search but is not validation evidence.",
        "3. Promote the discovered high-capacity form faithfully; do not replace an ML, feature-factory, dense ensemble, or hybrid lead with a simple proxy.",
