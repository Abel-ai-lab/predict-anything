...
exhaustion. Before stopping below target, check whether higher-ceiling search
axes remain untried, such as graph expansion, richer ensembles, high-capacity
construction, or local refinement around the strongest return lead.
