...
from abel_invest.narrative_core.gate_envelope import (
    load_or_synthesize_gate_envelope,
...
def build_agent_context(
    *,
    ...
    gate_envelope = load_or_synthesize_gate_envelope(load_session_state(session), frontier)
    return f"""# Agent Context Pack

generated by Abel Invest alpha-search narrative layer

{render_gate_envelope_summary(gate_envelope)}
