# Installing trade-anything for OpenCode
...
```json
{
  "plugin": ["abel@git+https://github.com/Abel-ai-causality/trade-anything.git"]
}
```
...
```json
{
  "plugin": ["abel@git+https://github.com/Abel-ai-causality/trade-anything.git#v1.4.2"]
}
```
