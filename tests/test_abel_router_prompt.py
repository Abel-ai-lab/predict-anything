...
def test_strategy_discovery_skill_explains_workspace_first_boundary() -> None:
    ...
    assert "high-capacity audited alpha discovery" in text
    assert "wide universe. narrow question. high-capacity promotion. harsh reporting" in text
    assert "scout one sharp question" in text
